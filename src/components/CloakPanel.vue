...
import { chainId, token_address, cloak_address } from '../store/config';
            ...
            */
                ...
                const sendMsg = {
                    send: {
                        ...
                        recipient: cloak_address, //cloak address
                ...
                let response = await this.$store.state.secretJs.execute(token_address, sendMsg, '', [], getFeeForExecute(150_000));
                if (response.code){
